...
local function create_components()
  ...
  M.goy_roll_manager = m.RollForChosen.new( db( "goy_roll" ) )
  M.goy_roll_gui = m.RollForChosenGui.new( M.goy_roll_manager, M.group_roster )
...
local function setup_slash_commands()
  ...
  SLASH_GOY1 = "/goy"
  M.api().SlashCmdList[ "GOY" ] = function() M.goy_roll_gui.toggle_window() end
